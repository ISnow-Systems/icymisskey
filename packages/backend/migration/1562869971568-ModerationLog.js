...
export class ModerationLog1562869971568 {
	async up(queryRunner) {
		await queryRunner.query(`CREATE TABLE "moderation_log"
								 (
									 ...
									 "info"      jsonb                    NOT NULL,
									 CONSTRAINT "PK_d0adca6ecfd068db83e4526cc26" PRIMARY KEY ("id")
								 )`);
		...
		await queryRunner.query(`ALTER TABLE "moderation_log"
			ADD CONSTRAINT "FK_a08ad074601d204e0f69da9a954" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
	}
