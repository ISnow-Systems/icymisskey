...
export class v12141580864313253 {
	...
	async up(queryRunner) {
		...
		await queryRunner.query(`ALTER TABLE "meta"
			ADD "proxyAccountId" character varying(32)`, undefined);
		await queryRunner.query(`ALTER TABLE "meta"
			ADD CONSTRAINT "FK_ab1bc0c1e209daa77b8e8d212ad" FOREIGN KEY ("proxyAccountId") REFERENCES "user" ("id") ON DELETE SET NULL ON UPDATE NO ACTION`, undefined);
	}
	...
	async down(queryRunner) {
		...
		await queryRunner.query(`ALTER TABLE "meta" DROP COLUMN "proxyAccountId"`, undefined);
		await queryRunner.query(`ALTER TABLE "meta"
			ADD "proxyAccountId" character varying(128)`, undefined);
