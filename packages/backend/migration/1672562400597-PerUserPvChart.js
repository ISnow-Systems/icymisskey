...
export class PerUserPvChart1672562400597 {
	...
	async up(queryRunner) {
		await queryRunner.query(`CREATE TABLE "__chart__per_user_pv"
								 (
									 "id"                        SERIAL                 NOT NULL,
									 "date"                      integer                NOT NULL,
									 "group"                     character varying(128) NOT NULL,
									 "unique_temp___upv_user"    character varying array NOT NULL DEFAULT '{}',
									 "___upv_user"               smallint               NOT NULL DEFAULT '0',
									 "___pv_user"                smallint               NOT NULL DEFAULT '0',
									 "unique_temp___upv_visitor" character varying array NOT NULL DEFAULT '{}',
									 "___upv_visitor"            smallint               NOT NULL DEFAULT '0',
									 "___pv_visitor"             smallint               NOT NULL DEFAULT '0',
									 CONSTRAINT "UQ_f2a56da57921ca8439f45c1d95f" UNIQUE ("date", "group"),
		...
		await queryRunner.query(`CREATE TABLE "__chart_day__per_user_pv"
								 (
									 "id"                        SERIAL                 NOT NULL,
									 "date"                      integer                NOT NULL,
									 "group"                     character varying(128) NOT NULL,
									 ...
									 "___upv_visitor"            smallint               NOT NULL DEFAULT '0',
									 "___pv_visitor"             smallint               NOT NULL DEFAULT '0',
									 CONSTRAINT "UQ_f221e45cfac5bea0ce0f3149fbb" UNIQUE ("date", "group"),
