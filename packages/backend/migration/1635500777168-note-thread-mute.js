...
export class noteThreadMute1635500777168 {
	...
	async up(queryRunner) {
		await queryRunner.query(`CREATE TABLE "note_thread_muting"
								 (
									 "id"        character varying(32)    NOT NULL,
									 "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL,
									 "userId"    character varying(32)    NOT NULL,
									 "threadId"  character varying(256)   NOT NULL,
									 CONSTRAINT "PK_ec5936d94d1a0369646d12a3a47" PRIMARY KEY ("id")
								 )`);
		...
		await queryRunner.query(`ALTER TABLE "note"
			ADD "threadId" character varying(256)`);
		...
		await queryRunner.query(`ALTER TABLE "note_thread_muting"
			ADD CONSTRAINT "FK_29c11c7deb06615076f8c95b80a" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
	}
