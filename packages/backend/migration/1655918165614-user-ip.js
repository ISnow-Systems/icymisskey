...
export class userIp1655918165614 {
	...
	async up(queryRunner) {
		await queryRunner.query(`CREATE TABLE "user_ip"
								 (
									 "id"        SERIAL                   NOT NULL,
									 "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL,
									 "userId"    character varying(32)    NOT NULL,
									 "ip"        character varying(128)   NOT NULL,
									 CONSTRAINT "PK_2c44ddfbf7c0464d028dcef325e" PRIMARY KEY ("id")
								 )`);
		...
		await queryRunner.query(`ALTER TABLE "user_ip"
			ADD CONSTRAINT "FK_7f7f1c66f48e9a8e18a33bc5150" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
	}
