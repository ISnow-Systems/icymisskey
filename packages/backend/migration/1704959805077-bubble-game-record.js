	...
	async up(queryRunner) {
		await queryRunner.query(`CREATE TABLE "bubble_game_record"
								 (
									 ...
									 CONSTRAINT "PK_a75395fe404b392e2893b50d7ea" PRIMARY KEY ("id")
								 )`);
		...
		await queryRunner.query(`ALTER TABLE "bubble_game_record"
			ADD CONSTRAINT "FK_75276757070d21fdfaf4c052909" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
	}
