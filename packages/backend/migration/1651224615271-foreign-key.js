...
export class foreignKeyReports1651224615271 {
	...
	async up(queryRunner) {
		await Promise.all([
			...
			INDEX "public"."IDX_seoignmeoprigmkpodgrjmkpormg" RENAME TO "IDX_c8cc87bd0f2f4487d17c651fbf"`),
			queryRunner.query(`DROP INDEX "public"."IDX_note_on_channelId_and_id_desc"`),

			// remove unnecessary default null, see also down
			queryRunner.query(`ALTER TABLE "user"
				ALTER COLUMN "followersUri" DROP DEFAULT`),
			queryRunner.query(`ALTER TABLE "access_token"
			...
			queryRunner.query(`ALTER TABLE "access_token"
				ALTER COLUMN "iconUrl" DROP DEFAULT`),
			queryRunner.query(`ALTER TABLE "instance"
				ALTER COLUMN "softwareName" DROP DEFAULT`),
			queryRunner.query(`ALTER TABLE "instance"
				ALTER COLUMN "softwareVersion" DROP DEFAULT`),
			queryRunner.query(`ALTER TABLE "instance"
				ALTER COLUMN "name" DROP DEFAULT`),
			queryRunner.query(`ALTER TABLE "instance"
				ALTER COLUMN "description" DROP DEFAULT`),
			queryRunner.query(`ALTER TABLE "instance"
				ALTER COLUMN "maintainerName" DROP DEFAULT`),
			queryRunner.query(`ALTER TABLE "instance"
				ALTER COLUMN "maintainerEmail" DROP DEFAULT`),
			queryRunner.query(`ALTER TABLE "instance"
				ALTER COLUMN "iconUrl" DROP DEFAULT`),
			queryRunner.query(`ALTER TABLE "instance"
				ALTER COLUMN "faviconUrl" DROP DEFAULT`),
			queryRunner.query(`ALTER TABLE "instance"
				ALTER COLUMN "themeColor" DROP DEFAULT`),
			queryRunner.query(`ALTER TABLE "clip"
				ALTER COLUMN "description" DROP DEFAULT`),
			queryRunner.query(`ALTER TABLE "note"
				ALTER COLUMN "channelId" DROP DEFAULT`),
			queryRunner.query(`ALTER TABLE "abuse_user_report"
	...
	async down(queryRunner) {
		await Promise.all([
			...
			queryRunner.query(`UPDATE "user_profile"
							   SET "mutingNotificationTypes" = array_remove("mutingNotificationTypes", 'pollEnded')`)
				.then(() =>
				...
				queryRunner.query(`ALTER TABLE "user_profile"
					ALTER COLUMN "mutingNotificationTypes" DROP DEFAULT`)
			).then(() =>
				...
				queryRunner.query(`ALTER TABLE "user_profile"
					ALTER COLUMN "mutingNotificationTypes" SET DEFAULT '{}'`)
			).then(() =>
			...
			queryRunner.query(`ALTER
			INDEX "public"."IDX_c8cc87bd0f2f4487d17c651fbf" RENAME TO "IDX_seoignmeoprigmkpodgrjmkpormg"`),
		]);
	}
}
