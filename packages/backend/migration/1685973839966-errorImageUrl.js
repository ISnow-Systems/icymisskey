...
export class ErrorImageUrl1685973839966 {
	...
	async up(queryRunner) {
		...
		await queryRunner.query(`ALTER TABLE "meta"
			ADD "serverErrorImageUrl" character varying(1024)`);
		await queryRunner.query(`ALTER TABLE "meta"
			ADD "notFoundImageUrl" character varying(1024)`);
		await queryRunner.query(`ALTER TABLE "meta"
			ADD "infoImageUrl" character varying(1024)`);
	}
	...
	async down(queryRunner) {
		...
		await queryRunner.query(`ALTER TABLE "meta"
			ADD "errorImageUrl" character varying(1024) DEFAULT 'https://xn--931a.moe/aiart/yubitun.png'`);
	}
}
