			...
			<MkHorizontalSwipe v-model:tab="tab" :tabs="headerTabs">
				<div v-if="tab === 'explore'" key="explore">
					<MkFoldableSection class="_margin">
						...
						<MkPagination v-slot="{items}" :disableAutoLoad="true" :pagination="recentPostsPagination">
					...
					<MkFoldableSection class="_margin">
						...
						<MkPagination v-slot="{items}" :disableAutoLoad="true" :pagination="popularPostsPagination">
							<div :class="$style.items">
								<MkGalleryPostPreview v-for="post in items" :key="post.id" :post="post" class="post"/>
							</div>
						</MkPagination>
				...
				<div v-else-if="tab === 'my'" key="my">
					<MkA class="_link" style="margin: 16px;" to="/gallery/new"><i class="ti ti-plus"></i> {{ i18n.ts.postToGallery }}</MkA>
