	...
	<div class="_gaps_m">
		<div :class="$style.banner" :style="{ backgroundImage: `url(${ instance.bannerUrl })` }">
			<div style="overflow: clip;">
				<img :class="$style.bannerIcon" :src="instance.iconUrl ?? instance.faviconUrl ?? '/favicon.ico'" alt=""/>
		...
		<FormSection>
			<div class="_gaps_m">
				<MkKeyValue :copy="version">
					<template #key>IcyMisskey</template>
		...
		<FormSection>
			...
			<div class="_gaps_s">
				<FormLink external to="/.well-known/host-meta">host-meta</FormLink>
				<FormLink external to="/.well-known/host-meta.json">host-meta.json</FormLink>
				<FormLink external to="/.well-known/nodeinfo">nodeinfo</FormLink>
				<FormLink external to="/robots.txt">robots.txt</FormLink>
				<FormLink external to="/manifest.json">manifest.json</FormLink>
			</div>
		</FormSection>
	</div>
</template>
