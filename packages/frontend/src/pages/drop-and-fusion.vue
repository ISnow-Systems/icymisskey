					...
					<div class="_woodenFrame" style="text-align: center;">
						<div class="_woodenFrameInner">
							<div class="_gaps" style="padding: 16px;">
								...
								<MkButton gradate inline large primary rounded @click="start">{{ i18n.ts.start }}</MkButton>
							</div>
						</div>
						<div class="_woodenFrameInner">
							<div class="_gaps" style="padding: 16px;">
							...
							<div class="_gaps_s" style="padding: 16px;">
								...
								<div v-if="ranking" class="_gaps_s">
									<div v-for="r in ranking" :key="r.id" :class="$style.rankingRecord">
										<MkAvatar :link="true" :user="r.user" style="width: 24px; height: 24px; margin-right: 4px;"/>
										<MkUserName :nowrap="true" :user="r.user"/>
