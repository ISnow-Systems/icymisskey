		...
		<MkSpacer :contentMax="900">
			<div :class="$style.root" class="_gaps">
				<div :class="$style.subMenus" class="_gaps">
					<MkButton link primary to="/admin/abuse-report-notification-recipient">{{ i18n.ts.notificationSetting }}</MkButton>
				</div>
				...
				<MkPagination ref="reports" v-slot="{items}" :pagination="pagination">
					<div class="_gaps">
