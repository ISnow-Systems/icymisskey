			...
			<div class="_gaps_s">
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.rateLimitFactor, 'rateLimitFactor'])">
					...
					<div class="_gaps">
						...
						<MkRange :max="400" :min="0" :modelValue="role.policies.rateLimitFactor.value * 100" :step="10" :textConverter="(v) => `${v}%`" @update:modelValue="v => role.policies.rateLimitFactor.value = (v / 100)">
							<template #label>{{ i18n.ts._role._options.rateLimitFactor }}</template>
							<template #caption>{{ i18n.ts._role._options.descriptionOfRateLimitFactor }}</template>
						</MkRange>
						<MkRange v-model="role.policies.rateLimitFactor.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.gtlAvailable, 'gtlAvailable'])">
					...
					<div class="_gaps">
						...
						<MkRange v-model="role.policies.gtlAvailable.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.ltlAvailable, 'ltlAvailable'])">
					...
					<div class="_gaps">
						...
						<MkRange v-model="role.policies.ltlAvailable.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.canPublicNote, 'canPublicNote'])">
					...
					<div class="_gaps">
						...
						<MkRange v-model="role.policies.canPublicNote.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.mentionMax, 'mentionLimit'])">
					...
					<div class="_gaps">
						...
						<MkInput v-model="role.policies.mentionLimit.value" :disabled="role.policies.mentionLimit.useDefault" :readonly="readonly" type="number">
						</MkInput>
						<MkRange v-model="role.policies.mentionLimit.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.canInvite, 'canInvite'])">
					...
					<div class="_gaps">
						...
						<MkRange v-model="role.policies.canInvite.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.inviteLimit, 'inviteLimit'])">
					...
					<div class="_gaps">
						...
						<MkInput v-model="role.policies.inviteLimit.value" :disabled="role.policies.inviteLimit.useDefault" :readonly="readonly" type="number">
						</MkInput>
						<MkRange v-model="role.policies.inviteLimit.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.inviteLimitCycle, 'inviteLimitCycle'])">
					...
					<div class="_gaps">
						...
						<MkInput v-model="role.policies.inviteLimitCycle.value" :disabled="role.policies.inviteLimitCycle.useDefault" :readonly="readonly" type="number">
							<template #suffix>{{ i18n.ts._time.minute }}</template>
						</MkInput>
						<MkRange v-model="role.policies.inviteLimitCycle.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.inviteExpirationTime, 'inviteExpirationTime'])">
					...
					<div class="_gaps">
						...
						<MkInput v-model="role.policies.inviteExpirationTime.value" :disabled="role.policies.inviteExpirationTime.useDefault" :readonly="readonly" type="number">
							<template #suffix>{{ i18n.ts._time.minute }}</template>
						</MkInput>
						<MkRange v-model="role.policies.inviteExpirationTime.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.canManageCustomEmojis, 'canManageCustomEmojis'])">
					...
					<div class="_gaps">
						...
						<MkRange v-model="role.policies.canManageCustomEmojis.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.canManageAvatarDecorations, 'canManageAvatarDecorations'])">
					...
					<div class="_gaps">
						...
						<MkRange v-model="role.policies.canManageAvatarDecorations.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.canSearchNotes, 'canSearchNotes'])">
					...
					<div class="_gaps">
						...
						<MkRange v-model="role.policies.canSearchNotes.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.canUseTranslator, 'canUseTranslator'])">
					...
					<div class="_gaps">
						...
						<MkRange v-model="role.policies.canUseTranslator.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.driveCapacity, 'driveCapacityMb'])">
					...
					<div class="_gaps">
						...
						<MkInput v-model="role.policies.driveCapacityMb.value" :disabled="role.policies.driveCapacityMb.useDefault" :readonly="readonly" type="number">
							<template #suffix>MB</template>
						</MkInput>
						<MkRange v-model="role.policies.driveCapacityMb.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.alwaysMarkNsfw, 'alwaysMarkNsfw'])">
					...
					<div class="_gaps">
						...
						<MkRange v-model="role.policies.alwaysMarkNsfw.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.canUpdateBioMedia, 'canUpdateBioMedia'])">
					...
					<div class="_gaps">
						...
						<MkRange v-model="role.policies.canUpdateBioMedia.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.pinMax, 'pinLimit'])">
					...
					<div class="_gaps">
						...
						<MkInput v-model="role.policies.pinLimit.value" :disabled="role.policies.pinLimit.useDefault" :readonly="readonly" type="number">
						</MkInput>
						<MkRange v-model="role.policies.pinLimit.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.antennaMax, 'antennaLimit'])">
					...
					<div class="_gaps">
						...
						<MkInput v-model="role.policies.antennaLimit.value" :disabled="role.policies.antennaLimit.useDefault" :readonly="readonly" type="number">
						</MkInput>
						<MkRange v-model="role.policies.antennaLimit.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.wordMuteMax, 'wordMuteLimit'])">
					...
					<div class="_gaps">
						...
						<MkInput v-model="role.policies.wordMuteLimit.value" :disabled="role.policies.wordMuteLimit.useDefault" :readonly="readonly" type="number">
							<template #suffix>chars</template>
						</MkInput>
						<MkRange v-model="role.policies.wordMuteLimit.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.webhookMax, 'webhookLimit'])">
					...
					<div class="_gaps">
						...
						<MkInput v-model="role.policies.webhookLimit.value" :disabled="role.policies.webhookLimit.useDefault" :readonly="readonly" type="number">
						</MkInput>
						<MkRange v-model="role.policies.webhookLimit.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.clipMax, 'clipLimit'])">
					...
					<div class="_gaps">
						...
						<MkInput v-model="role.policies.clipLimit.value" :disabled="role.policies.clipLimit.useDefault" :readonly="readonly" type="number">
						</MkInput>
						<MkRange v-model="role.policies.clipLimit.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.noteEachClipsMax, 'noteEachClipsLimit'])">
					...
					<div class="_gaps">
						...
						<MkInput v-model="role.policies.noteEachClipsLimit.value" :disabled="role.policies.noteEachClipsLimit.useDefault" :readonly="readonly" type="number">
						</MkInput>
						<MkRange v-model="role.policies.noteEachClipsLimit.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.userListMax, 'userListLimit'])">
					...
					<div class="_gaps">
						...
						<MkInput v-model="role.policies.userListLimit.value" :disabled="role.policies.userListLimit.useDefault" :readonly="readonly" type="number">
						</MkInput>
						<MkRange v-model="role.policies.userListLimit.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.userEachUserListsMax, 'userEachUserListsLimit'])">
					...
					<div class="_gaps">
						...
						<MkInput v-model="role.policies.userEachUserListsLimit.value" :disabled="role.policies.userEachUserListsLimit.useDefault" :readonly="readonly" type="number">
						</MkInput>
						<MkRange v-model="role.policies.userEachUserListsLimit.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.canHideAds, 'canHideAds'])">
					...
					<div class="_gaps">
						...
						<MkRange v-model="role.policies.canHideAds.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.avatarDecorationLimit, 'avatarDecorationLimit'])">
					...
					<div class="_gaps">
						...
						<MkInput v-model="role.policies.avatarDecorationLimit.value" :max="16" :min="0" type="number" @update:modelValue="updateAvatarDecorationLimit">
							<template #label>{{ i18n.ts._role._options.avatarDecorationLimit }}</template>
						</MkInput>
						<MkRange v-model="role.policies.avatarDecorationLimit.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.canImportAntennas, 'canImportAntennas'])">
					...
					<div class="_gaps">
						...
						<MkRange v-model="role.policies.canImportAntennas.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.canImportBlocking, 'canImportBlocking'])">
					...
					<div class="_gaps">
						...
						<MkRange v-model="role.policies.canImportBlocking.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.canImportFollowing, 'canImportFollowing'])">
					...
					<div class="_gaps">
						...
						<MkRange v-model="role.policies.canImportFollowing.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.canImportMuting, 'canImportMuting'])">
					...
					<div class="_gaps">
						...
						<MkRange v-model="role.policies.canImportMuting.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
				...
				<MkFolder v-if="matchQuery([i18n.ts._role._options.canImportUserLists, 'canImportUserLists'])">
					...
					<div class="_gaps">
						...
						<MkRange v-model="role.policies.canImportUserLists.priority" :max="2" :min="0" :step="1" :textConverter="(v) => v === 0 ? i18n.ts._role._priority.low : v === 1 ? i18n.ts._role._priority.middle : v === 2 ? i18n.ts._role._priority.high : ''" easing>
							<template #label>{{ i18n.ts._role.priority }}</template>
						</MkRange>
					</div>
				</MkFolder>
