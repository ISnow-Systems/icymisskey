									...
									<div class="_gaps_s">
										<div v-for="item in items" :key="item.user.id" :class="[$style.userItem, { [$style.userItemOpend]: expandedItems.includes(item.id) }]">
											<div :class="$style.userItemMain">
												...
												<button :class="$style.userToggle" class="_button" @click="toggleItem(item)"><i :class="$style.chevron" class="ti ti-chevron-down"></i></button>
												<button :class="$style.unassign" class="_button" @click="unassign(item.user, $event)"><i class="ti ti-x"></i></button>
											</div>
