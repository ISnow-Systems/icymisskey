...
<template>
	<MkStickyContainer>
		...
		<MkSpacer :contentMax="700" :marginMax="32" :marginMin="16">
			<div class="_gaps_m">
				<XBotProtection/>
				...
				<MkFolder>
					...
					<div class="_gaps_m">
						...
						<MkRange v-model="sensitiveMediaDetectionForm.state.sensitiveMediaDetectionSensitivity" :max="4" :min="0" :step="1" :textConverter="(v) => `${v + 1}`">
