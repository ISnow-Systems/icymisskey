			...
			<MkSpacer :contentMax="900">
				<div class="_gaps">
					<div class="inputs" style="display: flex; gap: var(--MI-margin); flex-wrap: wrap;">
						...
						<MkInput v-model="searchHost" :debounce="true" :disabled="pagination.params.origin === 'local'" style="margin: 0; flex: 1;" type="search">
							<template #label>{{ i18n.ts.host }}</template>
						</MkInput>
					</div>
					<div class="inputs" style="display: flex; gap: var(--MI-margin); flex-wrap: wrap;">
						<MkInput v-model="userId" :debounce="true" style="margin: 0; flex: 1;" type="search">
							<template #label>User ID</template>
						</MkInput>
						<MkInput v-model="type" :debounce="true" style="margin: 0; flex: 1;" type="search">
