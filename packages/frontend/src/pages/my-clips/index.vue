		...
		<MkSpacer :contentMax="700">
			<MkHorizontalSwipe v-model:tab="tab" :tabs="headerTabs">
				<div v-if="tab === 'my'" key="my" class="_gaps">
					<MkButton class="add" primary rounded @click="create"><i class="ti ti-plus"></i> {{ i18n.ts.add }}</MkButton>

					<MkPagination ref="pagingComponent" v-slot="{ items }" :pagination="pagination" class="_gaps">
