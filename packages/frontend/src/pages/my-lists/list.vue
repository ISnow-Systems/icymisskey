			...
			<div v-if="list" class="_gaps">
				<MkFolder>
					...
					<div class="_gaps">
						...
						<div class="_buttons">
							<MkButton primary rounded @click="updateSettings">{{ i18n.ts.save }}</MkButton>
							<MkButton danger rounded @click="deleteList()">{{ i18n.ts.delete }}</MkButton>
						</div>
					</div>
				</MkFolder>
				...
				<MkFolder defaultOpen>
					...
					<div class="_gaps_s">
						<MkButton primary rounded style="margin: 0 auto;" @click="addUser()">{{ i18n.ts.addUser }}</MkButton>
								...
								<div class="_gaps_s">
									<div v-for="item in items" :key="item.id">
										<div :class="$style.userItem">
											...
											<button :class="$style.menu" class="_button" @click="showMembershipMenu(item, $event)"><i class="ti ti-dots"></i></button>
											<button :class="$style.remove" class="_button" @click="removeUser(item, $event)"><i class="ti ti-x"></i></button>
										</div>
									</div>
								</div>
							</template>
