		...
		<div v-if="$i" class="_gaps_s">
			...
			<MkFolder :defaultOpen="true">
				...
				<div v-else-if="!$i.twoFactorEnabled" class="_gaps_s">
					<MkButton gradate primary @click="registerTOTP">{{ i18n.ts._2fa.registerTOTP }}</MkButton>
					<MkLink target="_blank" url="https://misskey-hub.net/docs/for-users/stepped-guides/how-to-enable-2fa/"><i class="ti ti-help-circle"></i> {{ i18n.ts.learnMore }}</MkLink>
				</div>
			</MkFolder>
