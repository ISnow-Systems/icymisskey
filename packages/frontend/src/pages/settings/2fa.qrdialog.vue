				...
				<template v-if="page === 0">
					<div style="height: 100cqh; overflow: auto; text-align: center;">
						<MkSpacer :marginMax="28" :marginMin="20">
							<div class="_gaps">
								<MkInfo>
									<MkLink target="_blank" url="https://misskey-hub.net/docs/for-users/stepped-guides/how-to-enable-2fa/">{{ i18n.ts._2fa.moreDetailedGuideHere }}</MkLink>
								</MkInfo>

								<I18n :src="i18n.ts._2fa.step1" tag="div">
									<template #a>
										<a class="_link" href="https://authy.com/" rel="noopener" target="_blank">Authy</a>
									</template>
									<template #b>
										<a class="_link" href="https://support.google.com/accounts/answer/1066447" rel="noopener" target="_blank">Google Authenticator</a>
									</template>
								</I18n>
								...
								<div>
									...
									<div>
										<MkButton :linkBehavior="'browser'" :to="twoFactorData.url" inline link rounded>{{ i18n.ts.launchApp }}</MkButton>
									</div>
								</div>
					...
					<div style="height: 100cqh; overflow: auto;">
						<MkSpacer :marginMax="28" :marginMin="20">
							...
							<div class="_buttonsCenter" style="margin-top: 16px;">
								...
								<MkButton gradate primary rounded @click="tokenDone">{{ i18n.ts.continue }} <i class="ti ti-arrow-right"></i></MkButton>
							</div>
						</MkSpacer>
					</div>
				</template>
							...
							<div class="_gaps">
								...
								<MkFolder :defaultOpen="true">
									...
									<div class="_gaps">
										...
										<MkButton gradate primary rounded @click="downloadBackupCodes"><i class="ti ti-download"></i> {{ i18n.ts.download }}</MkButton>
									</div>
								</MkFolder>
							</div>
							<div class="_buttonsCenter" style="margin-top: 16px;">
								<MkButton gradate primary rounded @click="allDone">{{ i18n.ts.done }}</MkButton>
							</div>
						</MkSpacer>
					</div>
				</template>
