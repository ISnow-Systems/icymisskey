...
<span :class="$style.root">
	...
	<svg v-for="particle in particles" :key="particle.id" :height="height" :viewBox="`0 0 ${width} ${height}`" :width="width" style="position: absolute; top: -32px; left: -32px; pointer-events: none;" xmlns="http://www.w3.org/2000/svg">
