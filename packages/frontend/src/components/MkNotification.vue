	...
	<div :class="$style.root">
		<div :class="$style.head">
			...
			>
				...
				<template v-else-if="notification.type === 'roleAssigned'">
					<img v-if="notification.role.iconUrl" :src="notification.role.iconUrl" alt="" style="height: 1.3em; vertical-align: -22%;"/>
		...
		<div :class="$style.tail">
			<header :class="$style.header">
				...
				<MkA v-else-if="notification.type === 'follow' || notification.type === 'mention' || notification.type === 'reply' || notification.type === 'renote' || notification.type === 'quote' || notification.type === 'reaction' || notification.type === 'receiveFollowRequest' || notification.type === 'followRequestAccepted'" v-user-preview="notification.user.id" :class="$style.headerName" :to="userPage(notification.user)">
				...
				<MkTime v-if="withTime" :class="$style.headerTime" :time="notification.createdAt"/>
			</header>
			<div>
				<MkA v-if="notification.type === 'reaction' || notification.type === 'reaction:grouped'" :class="$style.text" :title="getNoteSummary(notification.note)" :to="notePage(notification.note)">
					<i :class="$style.quote" class="ti ti-quote"></i>
					<Mfm :author="notification.note.user" :nowrap="true" :plain="true" :text="getNoteSummary(notification.note)"/>
					<i :class="$style.quote" class="ti ti-quote"></i>
				</MkA>
				<MkA v-else-if="notification.type === 'renote' || notification.type === 'renote:grouped'" :class="$style.text" :title="getNoteSummary(notification.note.renote)" :to="notePage(notification.note)">
					<i :class="$style.quote" class="ti ti-quote"></i>
					<Mfm :author="notification.note.renote?.user" :nowrap="true" :plain="true" :text="getNoteSummary(notification.note.renote)"/>
					<i :class="$style.quote" class="ti ti-quote"></i>
				</MkA>
				<MkA v-else-if="notification.type === 'reply'" :class="$style.text" :title="getNoteSummary(notification.note)" :to="notePage(notification.note)">
					<Mfm :author="notification.note.user" :nowrap="true" :plain="true" :text="getNoteSummary(notification.note)"/>
				</MkA>
				<MkA v-else-if="notification.type === 'mention'" :class="$style.text" :title="getNoteSummary(notification.note)" :to="notePage(notification.note)">
					<Mfm :author="notification.note.user" :nowrap="true" :plain="true" :text="getNoteSummary(notification.note)"/>
				</MkA>
				<MkA v-else-if="notification.type === 'quote'" :class="$style.text" :title="getNoteSummary(notification.note)" :to="notePage(notification.note)">
					<Mfm :author="notification.note.user" :nowrap="true" :plain="true" :text="getNoteSummary(notification.note)"/>
				</MkA>
				<MkA v-else-if="notification.type === 'note'" :class="$style.text" :title="getNoteSummary(notification.note)" :to="notePage(notification.note)">
					<Mfm :author="notification.note.user" :nowrap="true" :plain="true" :text="getNoteSummary(notification.note)"/>
				</MkA>
				<MkA v-else-if="notification.type === 'pollEnded'" :class="$style.text" :title="getNoteSummary(notification.note)" :to="notePage(notification.note)">
					<i :class="$style.quote" class="ti ti-quote"></i>
					<Mfm :author="notification.note.user" :nowrap="true" :plain="true" :text="getNoteSummary(notification.note)"/>
					<i :class="$style.quote" class="ti ti-quote"></i>
				</MkA>
				...
				<template v-else-if="notification.type === 'receiveFollowRequest'">
					...
					<div v-if="full && !followRequestDone" :class="$style.followRequestCommands">
						<MkButton :class="$style.followRequestCommandButton" primary rounded @click="acceptFollowRequest()"><i class="ti ti-check"/> {{ i18n.ts.accept }}</MkButton>
						<MkButton :class="$style.followRequestCommandButton" danger rounded @click="rejectFollowRequest()"><i class="ti ti-x"/> {{ i18n.ts.reject }}</MkButton>
					</div>
				</template>
				...
				<Mfm :nowrap="false" :text="notification.body"/>
			</span>
