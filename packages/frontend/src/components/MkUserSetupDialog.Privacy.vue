...
<template>
	<div class="_gaps">
		...
		<MkFolder>
			...
			<MkSwitch v-model="isLocked">{{ i18n.ts.makeFollowManuallyApprove }}
				<template #caption>{{ i18n.ts.lockedAccountInfo }}</template>
			</MkSwitch>
		</MkFolder>
		...
		<MkFolder>
			...
			<MkSwitch v-model="hideOnlineStatus">{{ i18n.ts.hideOnlineStatus }}
		...
		<MkFolder>
			...
			<MkSwitch v-model="noCrawle">{{ i18n.ts.noCrawle }}
		...
		<MkFolder>
			...
			<MkSwitch v-model="preventAiLearning">{{ i18n.ts.preventAiLearning }}
