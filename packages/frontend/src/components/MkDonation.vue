...
<template>
	<div :class="$style.root" class="_panel _shadow">
		...
		<div :class="$style.icon">
			<svg class="icon icon-tabler icon-tabler-pig-money" fill="none" height="40" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1" viewBox="0 0 24 24" width="40" xmlns="http://www.w3.org/2000/svg">
