...
<template>
	<TransitionGroup
		...
		:moveClass="defaultStore.state.animation ? $style.transition_x_move : ''" tag="div"
	>
		<XReaction v-for="[reaction, count] in reactions" :key="reaction" :count="count" :isInitial="initialReactions.has(reaction)" :note="note" :reaction="reaction" @reactionToggled="onMockToggleReaction"/>
