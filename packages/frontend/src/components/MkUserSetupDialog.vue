					...
					<div :class="$style.centerPage">
						...
						<MkSpacer :marginMax="28" :marginMin="20">
							<div class="_gaps" style="text-align: center;">
								...
								<MkButton data-cy-user-setup-continue gradate primary rounded style="margin: 16px auto 0 auto;" @click="page++">{{ i18n.ts._initialAccountSetting.profileSetting }} <i class="ti ti-arrow-right"></i></MkButton>
								<MkButton rounded style="margin: 0 auto;" transparent @click="later(true)">{{ i18n.ts.later }}</MkButton>
							</div>
						</MkSpacer>
					</div>
				</template>
						...
						<div :class="$style.pageRoot">
							...
							<div :class="$style.pageFooter">
								<div class="_buttonsCenter">
									<MkButton data-cy-user-setup-back rounded @click="page--"><i class="ti ti-arrow-left"></i> {{ i18n.ts.goBack }}</MkButton>
									<MkButton data-cy-user-setup-continue gradate primary rounded @click="page++">{{ i18n.ts.continue }} <i class="ti ti-arrow-right"></i></MkButton>
								</div>
							</div>
						</div>
					</div>
				...
				<template v-else-if="page === 3">
					<div style="height: 100cqh; overflow: auto;">
						...
						<div :class="$style.pageFooter">
							<div class="_buttonsCenter">
								<MkButton data-cy-user-setup-back rounded @click="page--"><i class="ti ti-arrow-left"></i> {{ i18n.ts.goBack }}</MkButton>
								<MkButton data-cy-user-setup-continue gradate primary rounded style="" @click="page++">{{ i18n.ts.continue }} <i class="ti ti-arrow-right"></i></MkButton>
							</div>
						</div>
					</div>
				</template>
					...
					<div :class="$style.centerPage">
						...
						<MkSpacer :marginMax="28" :marginMin="20">
							<div class="_gaps" style="text-align: center;">
								...
								<div class="_buttonsCenter" style="margin-top: 16px;">
									<MkButton data-cy-user-setup-continue gradate primary rounded @click="launchTutorial()">{{ i18n.ts._initialAccountSetting.startTutorial }} <i class="ti ti-arrow-right"></i></MkButton>
								</div>
								<div class="_buttonsCenter">
									<MkButton data-cy-user-setup-back rounded @click="page--"><i class="ti ti-arrow-left"></i> {{ i18n.ts.goBack }}</MkButton>
									<MkButton data-cy-user-setup-continue primary rounded @click="setupComplete()">{{ i18n.ts.close }}</MkButton>
								</div>
							</div>
						</MkSpacer>
					</div>
