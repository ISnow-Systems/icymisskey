...
<template>
	<div :class="$style.root">
		<MkFoldableSection class="item">
			...
			<div :class="$style.chart">
				...
				<div class="chart _panel">
					<MkChart :detailed="true" :limit="chartLimit" :span="chartSpan" :src="chartSrc"></MkChart>
				</div>
			</div>
		</MkFoldableSection>
		...
		<MkFoldableSection class="item">
			...
			<div :class="$style.heatmap" class="_panel">
				<MkHeatmap :label="'Read & Write'" :src="heatmapSrc"/>
			</div>
		</MkFoldableSection>

		<MkFoldableSection class="item">
			<template #header>Retention rate</template>
			<div :class="$style.retentionHeatmap" class="_panel">
				<MkRetentionHeatmap/>
			</div>
			<div :class="$style.retentionLine" class="_panel">
