	...
	<MkFolder>
		...
		<div class="_gaps_s">
			<MkFolder :withSpacer="false">
				<template #icon>
					<MkAvatar :user="report.targetUser" style="width: 18px; height: 18px;"/>
				</template>
				<template #label>{{ i18n.ts.target }}:
					<MkAcct :user="report.targetUser"/>
				</template>
			...
			<MkFolder :defaultOpen="true">
				...
				<div class="_gaps_s">
					<Mfm :linkNavigationBehavior="'window'" :text="report.comment"/>
				</div>
			</MkFolder>
			...
			<MkFolder :withSpacer="false">
				...
				<template #label>{{ i18n.ts.reporter }}:
					<MkAcct :user="report.reporter"/>
				</template>
