...
<template>
	<MkContainer :scrollable="true" :showHeader="widgetProps.showHeader" :style="`height: ${widgetProps.height}px;`" class="mkw-timeline" data-cy-mkw-timeline>
		<template #icon>
		...
		<div v-else>
			<MkTimeline :key="widgetProps.src === 'list' ? `list:${widgetProps.list.id}` : widgetProps.src === 'antenna' ? `antenna:${widgetProps.antenna.id}` : widgetProps.src" :antenna="widgetProps.antenna ? widgetProps.antenna.id : null" :list="widgetProps.list ? widgetProps.list.id : null" :src="widgetProps.src"/>
		</div>
	</MkContainer>
</template>
